...
| [`serviceGatewayResourceId`](#parameter-servicegatewayresourceid) | string | The resource ID of the service gateway associated with the subnet. |
...
### Parameter: `serviceGatewayResourceId`
